...
export function OnboardingTour() {
  ...
  const primaryColor =
    theme?.colors?.button?.primary || theme?.colors?.secondary || "#0A3A3A";
  const logoSrc = theme?.images?.logo;
  ...
  useEffect(() => {
    ...
    const applyStyles = () => {
      styleElement.textContent = `
        /* Cor secundária para todo o texto do tooltip - força com !important */
        [data-testid="react-joyride-tooltip"] p,
        [data-testid="react-joyride-tooltip"] span:not([class*="button"]),
        [data-testid="react-joyride-tooltip"] div:not([class*="button"]),
        [data-testid="react-joyride-tooltip"] strong,
        .react-joyride__tooltip p,
        .react-joyride__tooltip span:not([class*="button"]),
        .react-joyride__tooltip div:not([class*="button"]),
        .react-joyride__tooltip strong,
        [class*="react-joyride__tooltip"] p,
        [class*="react-joyride__tooltip"] span:not([class*="button"]),
        [class*="react-joyride__tooltip"] div:not([class*="button"]),
        [class*="react-joyride__tooltip"] strong {
          color: ${themeColors.secondary} !important;
        }
        
        /* Remover qualquer seta criada via CSS ::after */
        button[data-test-id="button-primary"]::after,
        button[class*="react-joyride__button--next"]::after,
        button[class*="button--next"]::after,
        button[aria-label="Próximo"]::after,
        .react-joyride__button--next::after,
        [class*="react-joyride__button--next"]::after {
          content: none !important;
        }
        
        /* Exceção para botões - manter cor do texto do botão (não aplicar cor secundária) */
        button[class*="react-joyride__button"],
        button[data-test-id="button-primary"],
        .react-joyride__button--next,
        .react-joyride__button--skip {
          color: ${theme?.colors?.button?.text || "#FFFFFF"} !important;
        }
      `;
    };
      ...
      timeoutId = setTimeout(() => {
        ...
        try {
          ...
          nextButtons.forEach((button) => {
            ...
            path1.setAttribute('stroke', themeColors.secondary);
            path1.setAttribute('stroke-linecap', 'round');
            path1.setAttribute('stroke-linejoin', 'round');
            
            const path2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
            path2.setAttribute('d', 'M14.2858 15L19.2858 10L14.2858 5');
            path2.setAttribute('stroke', themeColors.secondary);
  ...
  }, [isMounted, runTour, themeColors.secondary, theme?.colors?.button?.text]);
  ...
  const steps: Step[] = [
    {
      ...
      content: (
        <Box sx={{ maxWidth: { xs: "100%", sm: 400 } }}>
          ...
          >
            Use o botão <strong>&quot;Acessar app do plano&quot;</strong> para
            abrir diretamente o ambiente da operadora.
          </Typography>
        </Box>
      ),
    },
    {
      ...
      content: (
        <Box sx={{ maxWidth: 360 }}>
          <Typography sx={{ mb: 1.5, fontSize: 14, lineHeight: 1.5, color: themeColors.secondary }}>
            Suas condições pré-existentes, medicamentos e alergias ficam aqui.
          </Typography>
          <Typography sx={{ fontSize: 14, lineHeight: 1.5, color: themeColors.secondary }}>
        ...
        >
          ...
          <Box
            sx={{
              ...
              height: { xs: 56, sm: 64 },
              borderRadius: "50%",
              bgcolor: themeColors.iconBackground,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              mx: "auto",
          ...
          >
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  backgroundColor:
                    theme?.colors?.button?.primaryHover || primaryColor,
                },
              }}
            >
              Concluir tour
          ...
          <IconButton
           ...
           >
              ...
              >
                ...
                <g mask="url(#mask0_tour_modal)">
                  <circle
                    ...
                    cy="120"
                    r="120"
                    fill={theme?.colors?.secondary || themeColors.secondary}
                  />
                  <DynamicStrokeElement
                    stroke={primaryColor}
                    strokeWidth="1.5"
            ...
            >
              ...
              >
                <DynamicStrokeElement
                  stroke={theme?.colors?.secondary || themeColors.secondary}
                  strokeWidth="1.5"
                >
