...
export function HeroBanner() {
  ...
  return (
    ...
    >
      ...
      >
      <Box
        aria-labelledby="admin-rh-hero-title"
        sx={{
          position: "relative",
      ...
      >
        ...
        >
          <Image
            src="/admin-rh/banner_dashboard.png"
            alt=""
            fill
            priority
        ...
        >
          <Box
            sx={{
              width: { xs: "100%", sm: "100%", lg: 357 },
              maxWidth: { xs: "100%", lg: 357 },
          ...
          >
            ...
            >
              Visualize beneficiários, edite layouts e mantenha tudo alinhado
              com o{" "}
          ...
          {/* FOTO - apenas desktop acima de 1200px */}
          <Box
            sx={{
          ...
          >
            <Image
              src="/admin-rh/person_dashboard.png"
              alt="Chef sorridente vestindo uniforme branco, representando o público da Trigo."
              width={403}
              height={361}
              sizes="403px"
              style={{
