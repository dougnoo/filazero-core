# =============================================================================
# Platform Files Bucket - HML Environment
# =============================================================================
...
#
# Para criar bucket:
#   cd environments/hml && terraform apply -target=module.platform_files
# =============================================================================
...
module "platform_files" {
  ...
  bucket_name = "trya-platform-files-hml"
  environment = "hml"
  region      = "us-east-1"
  ...
  #   "trya-platform-backend-hml-ecs-task-role"
  # ]
