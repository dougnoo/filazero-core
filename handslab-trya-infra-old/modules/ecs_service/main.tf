...
# Ingress from ALB (for external security group)
resource "aws_vpc_security_group_ingress_rule" "ecs_from_alb_external" {
...
# Note: Egress rule for task security group should be defined where the SG is created
# This avoids duplicate rule errors when SG is passed from outside
