...
export function FAQChatInput({ onSendMessage, disabled = false }: FAQChatInputProps) {
        ...
        InputProps={{
          endAdornment: (
            <InputAdornment position="end">
              ...
              >
                <SendIcon color={!message.trim() || disabled ? "#4A6060" : theme.palette.primary.contrastText} />
                Enviar
              </Box>
            </InputAdornment>
          ),
