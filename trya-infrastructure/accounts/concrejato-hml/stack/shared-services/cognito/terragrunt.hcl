...
inputs = {
  ...
  explicit_auth_flows = [
    ...
    "ALLOW_USER_AUTH"            # Custom challenges (New Password)
  ]
  ...
  callback_urls = [
    ...
    "https://app.hml.grupo-trigo.skopiadigital.com.br/auth/callback"
  ]
  logout_urls = [
    "http://localhost:3000/auth/logout",
    "https://app.hml.grupo-trigo.skopiadigital.com.br/auth/logout"
  ]
