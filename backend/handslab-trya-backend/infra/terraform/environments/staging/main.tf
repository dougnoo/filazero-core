# =============================================================================
# Trya Backend - HML (Staging)
# =============================================================================
# Symlink ou copia do main.tf do dev
# Para manter sincronizado, considere usar um symlink:
#   ln -s ../dev/main.tf main.tf
# =============================================================================
...
module "ecr" {
  ...
  repository_name      = "${var.project_name}-hml"
...
module "ecs" {
  ...
  # Fargate Spot desabilitado em HML
  ...
  environment_variables = [
    ...
    { name = "ELASTICACHE_HOST", value = var.elasticache_host },
    { name = "ELASTICACHE_PORT", value = tostring(var.elasticache_port) },
    { name = "ELASTICACHE_TLS", value = var.elasticache_tls },
    { name = "REDIS_HOST", value = var.elasticache_host },
    { name = "REDIS_PORT", value = tostring(var.elasticache_port) },
    { name = "CACHE_ENABLED", value = var.elasticache_host != "" ? "true" : "false" },
...
# Security Group Rule: ElastiCache <- ECS
