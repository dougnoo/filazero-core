...
variable "elasticache_security_group_id" {
  description = "Security Group ID attached to the ElastiCache (Serverless) cache. Used to allow inbound from ECS tasks SG."
  type        = string
  default     = ""
}
...
variable "postgres_host" {
  description = "PostgreSQL host (used if not using Aurora)"
  type        = string
  default     = ""
}
...
variable "database_url" {
  description = "Full database URL (used if not using Aurora)"
  type        = string
  default     = ""
}
