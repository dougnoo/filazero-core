# =============================================================================
# Tenant Assets Buckets - HML Environment
# =============================================================================
...
#
# Exemplo de import:
#   terraform import 'module.tenant_assets["grupotrigo"].aws_s3_bucket.tenant_assets' grupotrigo-assets-hml
# =============================================================================
...
locals {
  ...
  tenant_config = {
    trya = {
      name           = "trya"
      dynamodb_table = "tenant-1-hml"
      domain         = "hml-app.trya.ai"
    }
    grupotrigo = {
      name           = "grupotrigo"
      dynamodb_table = "grupotrigo-hml"
...
module "tenant_assets" {
  ...
  cors_allowed_origins = [
    ...
    "https://hml-api.trya.ai",
    "https://api-hml.trya.ai",
    "http://localhost:3000"
  ]
...
module "tenant_bucket_access" {
  ...
  read_access_role_names = [
    # "Trya-hml-v2-ecs-task-role",
    # "trya-platform-backend-hml-service-ecs-task-role",
  ]
