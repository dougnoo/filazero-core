...
inputs = {
  ...
  environment_variables = {
    ...
    KNOWLEDGE_BASE_ID     = "DBVNC1XD9Z"
    STORAGE_BACKEND       = "hybrid"
    CACHE_ENDPOINT        = "grupo-trigo-hml-cache-5fwwk6.serverless.use1.cache.amazonaws.com"
    CACHE_PORT            = "6379"
    SESSIONS_TABLE_NAME   = "${local.account_name}-sessions"
    BUCKET_NAME           = "${local.account_name}-triagem-ia"
    CACHE_TTL             = "3600"
    TRYA_API_PLATFORM_URL = "https://platform.hml.grupo-trigo.skopiadigital.com.br"
    TRYA_API_PLATFORM_KEY = "Tr7revjJDZJaae3Xz5G7v8K3bH9mU6nYX"
    TENANT_API_URL        = "https://api.hlm.grupo-trigo.skopiadigital.com.br"
